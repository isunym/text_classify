...
def plot_confusion_matrix(cm, classes, normalize=False, title='Confusion matrix', figname='confusion_less', cmap=plt.cm.Blues):
...
#               '720200', '720300', '730100', '730200']
    classes = ['D001002001', 'D001002002', 'D001002003', 'D001003001', 'D001003002', 'D001003003', 'D001004001',
...
#    base_dir = "/home/abc/pzw/nlp/data/0410/"
    base_dir = "/home/abc/pzw/nlp/data/txt_json/"
    print '(1) 读取需要被分类的文档...'
    print current_time()
    test_texts = pd.read_csv(base_dir+'train_csv_ht03/test.csv', compression=None, error_bad_lines=False)
    ...
    print current_time()
    count_v0 = get_count(all_texts=[], max_features=20000, save=True, vocab_dir=base_dir+train_tmp_dir+'all_features_dir/')
    ...
    ch = 1000
    tfidf_df_1 = get_x_test(count_v0_df, features_index_by_ch2_dir=base_dir+train_tmp_dir+'features_index_by_tf1000ch2_'+str(ch)+'/')

    print '(4) 引入模型并预测类别...'
    print current_time()
    with open(base_dir+train_tmp_dir+'new_model/svm_c29ch1000s0.8072.pkl', 'rb') as fr:
#    with open(base_dir+train_tmp_dir+'new_model/svm_c23ch1000s0.7737.pkl', 'rb') as fr:
    ...
    cm_df.to_csv('confusion_29_ht04.csv')
    plot_confusion_matrix(cm, classes, figname='confusion_29_ht04')
